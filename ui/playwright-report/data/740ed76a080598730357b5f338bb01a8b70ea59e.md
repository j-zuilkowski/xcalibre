...
- Name: 04-settings.spec.ts >> Settings modal >> Reader section has theme selector
- Location: e2e/04-settings.spec.ts:40:3
...
Locator:  locator('select').first().locator('option[value="light"]')
Expected: 1
Received: 0
Timeout:  8000ms
...
Call log:
  ...
  - waiting for locator('select').first().locator('option[value="light"]')
