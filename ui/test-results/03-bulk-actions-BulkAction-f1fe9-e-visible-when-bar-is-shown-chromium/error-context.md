...
- Name: 03-bulk-actions.spec.ts >> BulkActionBar >> all action buttons are visible when bar is shown
- Location: e2e/03-bulk-actions.spec.ts:25:3
...
Locator: getByRole('button', { name: 'Repair' })
Expected: visible
Error: strict mode violation: getByRole('button', { name: 'Repair' }) resolved to 2 elements:
    1) <button class="px-3 py-1.5 text-sm rounded-lg border border-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800">Repair library</button> aka getByRole('button', { name: 'Repair library' })
    2) <button class="text-sm px-3 py-1.5 rounded bg-amber-500 text-white hover:bg-amber-600">Repair</button> aka getByRole('button', { name: 'Repair', exact: true })

Call log:
  - Expect "toBeVisible" with timeout 8000ms
  - waiting for getByRole('button', { name: 'Repair' })
...
- generic [ref=e3]:
  ...
  - generic [ref=e13]:
    ...
    - main [ref=e30]:
      - generic [ref=e31]:
        - generic [ref=e32] [cursor=pointer]:
          - checkbox [checked] [active] [ref=e34]
    ...
    - generic [ref=e78]:
      - generic [ref=e79]: 1 selected
      - button "Edit metadata" [ref=e80] [cursor=pointer]
      - button "Convert to EPUB" [ref=e81] [cursor=pointer]
      - button "Repair" [ref=e82] [cursor=pointer]
      - button "Re-ingest" [ref=e83] [cursor=pointer]
      - button "Export CSV" [ref=e84] [cursor=pointer]
